...
$.widget('Open311.neighborhoodsSCTrends', $.Open311.neighborhoodsTrends, {
  ...
  console.log("DATA ROWS LENGTH " + data.rows.length);
	...
	if(data.rows.length > 0) {
      ...
      var img_query_string = '<img src=' + '\"' + 'http://chart.apis.google.com/chart?chxs=0,676767,11.5,0,l,FFFFFF|1,FFFFFF,11.5,0,_,FFFFFF&cht=bhs&chxt=y,x&chbh=a&chs=220x200&chco=1d8dc3&chds=0,400&chxr=0,0,400&chd=t:' + data_points.join(',') + '&chxl=0:|' + labels.reverse().join('|') + '&chm=' + data_bars.reverse().join('|') + '\"></img>';
