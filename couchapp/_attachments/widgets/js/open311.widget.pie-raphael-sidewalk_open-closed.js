...
$.widget('widget.pieRaphaelSidewalkOpenClosed', $.Open311.pieRaphael, {
  options: {
    title: 'Sidewalk Open vs Closed',
  ...
  if(data.rows.length > 0) {
    var sidewalk_total = 332;
    var the_rest = 11616;
    var totReqs = 11948;
            
    var pieces =  [
      {title: "Open Requests in 2011", fraction:(sidewalk_total/totReqs).toFixed(2)}, 
      {title: "Closed Requests in 2011", fraction:(the_rest/totReqs).toFixed(2)}
    ];
    ...
    var description = canvas.text(100, 170, "2011 Sidewalk Requests");
    ...
    .mouseout(function () {
      ...
      description.attr({text:"2011 Sidewalk Requests"});
    });
